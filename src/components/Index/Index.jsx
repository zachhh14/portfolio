  ...
  return (
    <div className='p-40 text-center md:p-60 hero-section'>
      <div className='flex flex-col items-center text-white intro-message'>
        <h1 className='text-3xl font-normal md:text-4xl mb-7' data-aos='zoom-in'>
          Hello, I'm <br />
        ...
        <span className='mt-4 text-xl font-light whitespace-nowrap md:text-2xl' data-aos='zoom-in'>
          Software Developer
        </span>
      </div>
    </div>
